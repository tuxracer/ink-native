...
/** Create a mock UiRenderer */
const createMockRenderer = (): UiRendererLike => {
	return {
		processAnsi: vi.fn(),
		present: vi.fn(),
		clear: vi.fn(),
...
describe("OutputStream", () => {
	...
	let mockRenderer: UiRendererLike;

	beforeEach(() => {
		mockRenderer = createMockRenderer();
		stream = new OutputStream(mockRenderer);
	});
